...
/*
Plugin Name: paystar-easy-donations
Plugin URI: https://paystar.ir
Description: paystar-easy-donations
Version: 1.0
Author: پی استار
 */
...
if( !class_exists('Easy_Donations') ){
    ...
    final class Easy_Donations {
        ...
        public function __construct() {
            ...
            $this->includes();
            $this->init();
            __('paystar-easy-donations', EDT_TEXT_DOMAIN);
        }
        ...
        public function includes() {
            ...
            //Default Gateways
            include_once $dir . 'inc/gateways/class-edt-paystar-gateway.php';
