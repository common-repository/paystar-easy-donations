...
class Easy_Donations_Form extends Easy_Donations_Settings_API {
    ...
    public function __construct(){
        ...
        if( isset( $_POST['easy_donations_form'] ) && sanitize_text_field($_POST['easy_donations_form']) == '1' ) {
    ...
    public function get_amount_field() {
        ...
        $active_currency = ( $active_currency != '' ) ? $active_currency : array( 'Code' => 'IRT', 'Title' => __( 'Iranian Toman', EDT_TEXT_DOMAIN ) ) ;
    ...
    public function easy_donations_form() {
        ...
        if( isset( $_GET['edt_session_key'] ) ) {
            if( $successfull_payment && ! empty( $successfull_payment ) && isset( $successfull_payment['show_form_after_successfull_payment'] ) && trim( $successfull_payment['successfull_payment_message'] ) != '' ) {
                ...
                $temp = sanitize_text_field($_GET['edt_session_key']);
                $temp2 = array();
    ...
    public function the_easy_donations_form() {
        echo esc_html($this->easy_donations_form());
    }
    ...
    public function form_styles() {
        ...
        <style type="text/css">
            ...
            <?php echo esc_html($wrapper_styles); ?>
            ...
            <?php echo esc_html(edt_ins()->options->get_option( 'form_custome_styles' )); ?>
        </style>
        <?php
    }
