...
<?php
			foreach ( $modes as $mode => $title ) {
				...
				echo "<a href='" . esc_url( add_query_arg( 'mode', $mode, $_SERVER['REQUEST_URI'] ) ) . "' ".esc_html($class)."><img id='view-switch-".esc_html($mode)."' src='" . esc_url( includes_url( 'images/blank.gif' ) ) . "' width='20' height='20' title='".esc_html($title)."' alt='".esc_html($title)."' /></a>\n";
			}
		?>
		</div>
<?php
